...
{
    public static final DynamicCommandExceptionType NO_SUCH_FILE_EXCEPTION = new DynamicCommandExceptionType((v) -> Component.literal("No such file: " + v));
    private static final SimpleCommandExceptionType EMPTY_FILE_NAME = new SimpleCommandExceptionType(Component.literal("Empty file name"));
    private static final SimpleCommandExceptionType NO_DIRECTORY = new SimpleCommandExceptionType(Component.literal("No base directory set"));
